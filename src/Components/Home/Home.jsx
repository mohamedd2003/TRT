        ...
        <section id='about' className='mt-5'>
          <div className="container">
            <div className="row mt-5 gx-5">
              ...
              <div className="col-lg-6 ">
                <div className="breif">
  <span className='text-muted ms-lg-5 h5'><i className="fa-solid fa-t fa-sm"></i><i className="fa-brands  fa-r-project fa-sm my-5"></i><i className="fa-solid fa-t fa-sm"></i></span>
  <h3 className='main-font h1   mb-4 text-muted '>ABOUT U<i className="fa-solid fa-bolt fa-md text-main"></i></h3>

  <p className='text-muted ms-lg-5'><span className='text-main'>  TRT </span> exhibition organizing team was established in <span className='text-main'>2022</span> , where we organized our first event on <span className='text-main'>2022</span>, 
  ...
  Our Mission : is to continue organizing outstanding events that cater to the interests of car enthusiasts and owners of modified cars, providing a platform for them to showcase their passion and connect with like-minded individuals. We are committed to upholding the highest standards of professionalism and creating a safe and enjoyable environment for all participants. With a focus on innovation and creativity, we aim to set new benchmarks in the industry and establish ourselves as a leader in event organizing for car enthusiasts in the Arab Republic of Egypt. "Make your passion safe" is not just a slogan for us, but a guiding principle that drives everything we do.
  "Make your passion safe"</p>
                </div>
              </div>
            </div>
          </div>
